...
Settings=$(jq -r '.Settings' "/hive/miners/custom/$CUSTOM_NAME/qubicmine_global.json" | envsubst)

# Delete old settings
eval "rm -rf /hive/miners/custom/$CUSTOM_NAME/cpu/qubicmine.json"
eval "rm -rf /hive/miners/custom/$CUSTOM_NAME/gpu/qubicmine.json"
